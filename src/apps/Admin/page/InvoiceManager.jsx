...
function Invoice() {
    ...
    return (
        <div className="h-screen pt-12">
            ...
            <button
                type="button"
                className="w-30 h-8 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-sans rounded-lg text-sm px-5 py-1 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 "
                ...
                <table className="w-full h-full">
                    ...
                    <tbody>
                        {orders.map((item, rowIndex) => (
                            <tr key={rowIndex} name={rowIndex} onClick={() => handleRowClick(item.orderID)} className="cursor-pointer border-b  border-black hover:bg-gray-400">
                                ...
                                <td className="text-center border-r border-black" >{formatter.format(item.totalPrice)} </td>
                                ...
                                <td className="text-center border-r border-black" >{moment(item.orderDay).format('DD-MM-YYYY hh:mm:ss A')}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
