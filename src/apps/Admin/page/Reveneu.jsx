...
function Reveneu() {
    ...
    const inputYear = [
        { type: "year", names: "yearStart", id: "YearFrom", placeholder: "Year Start" },
                        ...
                        <div>
                            ...
                            <div className="w-12/12 flex">
                                ...
                                <div className="py-3 px-2">
                                    <button
                                        type="button"
                                        className=" w-30 h-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-sans rounded-lg text-sm px-5 py-1 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 "
