...
function Card({ bookName, bookPrice, bookPriceAfterDiscount, margin }) {
  return (
    ...
    // </section>
    <section className={`bg-background400 min-h-[340px] w-60 relative`}>
      <p className="line-clamp-3 hover:line-clamp-none pt-40 absolute">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa dolore
        doloremque nam dolorem repellat neque sit ipsam officiis in dicta
        adipisci eaque, tenetur velit voluptates error excepturi alias
        consequatur! Placeat.
      </p>
    </section>
  );
